...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/20 14:47:07 by sungjuki          #+#    #+#             */
/*   Updated: 2022/11/21 15:28:19 by dokwak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "../inc/cub3d.h"
...
//move player
//and if left or right key pressed, update ray angle
//left(right) vs a(d)?
...
// if texture next exit -> update text to text's next node
