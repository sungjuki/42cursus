...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/16 16:56:58 by sungjuki          #+#    #+#             */
/*   Updated: 2022/11/21 13:37:05 by dokwak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "../inc/cub3d.h"

static char	**check_textures_trim_space(char *trim, t_game *g)
{
	char	**dir;
...
void	check_textures(char *trim, t_game *g, int n[0][2])
{
	...
	dir = check_textures_trim_space(trim, g);
